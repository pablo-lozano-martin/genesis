// ABOUTME: Registration page for creating new user accounts
// ABOUTME: Simple form with username, email, password, and full name fields
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              required
              className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 dark:bg-gray-900 dark:text-white rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-gray-900"
            />
          </div>
